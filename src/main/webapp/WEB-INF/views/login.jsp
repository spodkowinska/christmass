            ...
            $("#form").validate({
                ...
                messages: {
                    username: {
                        ...
                        <%--              <spring:message code="pl.coderslab.christmass.enterLogin"/>,--%>
                        email: "Email needs to include an \"@\""
                        <%--              <spring:message code="pl.coderslab.christmass.enterLogin@"/>--%>
                    },
                    password: {
                        required: "Enter password",
                        <%--                      <spring:message code="pl.coderslab.christmass.enterPass"/>,--%>
                        minlength: "Password needs to have at least three characters"
                        <%--                      <spring:message code="pl.coderslab.christmass.enterPassLength"/>--%>
                    }
                },
